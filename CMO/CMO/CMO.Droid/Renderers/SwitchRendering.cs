        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Switch> e)
        {
            ...
            if (Control != null)
            {
              ...
              //  var x = Control.ThumbDrawable;
               ...
               // x.SetColorFilter(Android.Graphics.Color.Rgb(244, 116, 33), PorterDuff.Mode.SrcIn);

                ////for switch background bar color
                var y = Control.TrackDrawable;
                y.SetColorFilter(Android.Graphics.Color.Rgb(244, 116, 33), PorterDuff.Mode.Multiply);
            }
        }
    }
}