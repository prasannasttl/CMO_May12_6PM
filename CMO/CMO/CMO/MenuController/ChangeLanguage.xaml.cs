...
namespace CMO.MenuController
{
    public partial class ChangeLanguage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            if (Application.Current.Properties.ContainsKey("Language"))
            { current_language = Application.Current.Properties["Language"] as string; }
        }
        protected override void OnDisappearing()
        {
            if (current_language != Application.Current.Properties["Language"] as string)
            {
                CMO.MenuController.HomeScreen.NEWSLIST = null;
                CMO.MenuController.HomeScreen.PHOTOSLIST = null;
                CMO.MenuController.HomeScreen.VIDEOSLIST = null;
            }
        }
